...
namespace Concise_CMS.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        private readonly Concise_CMSDbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(Concise_CMSDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new Concise_CMSAuthorizationProvider())
